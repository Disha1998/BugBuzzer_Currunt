  ...
  return (
    <>
      <Container>
        ...
        <Typography className='bug' fontWeight='bold' variant='h4' mt={10} style={{ marginLeft: '-16px' }} mb={-4} >
        ...
        <Box mt={5}>
          <Box className='border' sx={{ borderBottom: 1, width: 1130, color: "#E5E5E5" }} mb={4} ml={-2}>

            <Typography color='black'>
              <span className='detail' style={{ fontWeight: 'bold' }}>    Facing error in writing smart contracts and integrating in Hardhat   </span> <br />
              <span>upvote Downvote Answers(5) </span>
              <span className='span' style={{ marginLeft: '700px' }}>12 March 2022  by Alex Patel</span>
            </Typography>
