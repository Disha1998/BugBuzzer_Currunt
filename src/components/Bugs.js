...
const Bugs = () => {
  return (
    <>
      <Typography className='bug' fontWeight='bold' variant='h4' ml={1.5} mt={10}>
        Let's Report:
      </Typography>
      <Typography className='second' m={1.8}>
    ...
    <Card sx={{ width:165, height: 140 ,color:"white", mb:2, backgroundColor:"#D82148" }}>
    <CardContent>
  ...
  <Card  variant='outlined'sx={{ width:165, height: 140 ,mb:2, color:"#D82148",borderColor:"#D82148" }}>
    <CardContent>
      <Typography variant="subtitle2" mt={4} fontWeight = 'bold' gutterBottom justifycontent="center" textAlign="center">
